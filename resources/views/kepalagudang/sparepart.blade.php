...
<body>
    ...
    <div class="sidebar">
        <div class="list-group list-group-flush">
            ...
            <a href="{{ route('kepalagudang.sparepart.index') }}" class="list-group-item list-group-item-action py-3 active">
    ...
    <div class="main-content">
        ...
        <div class="table-container">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex">
                    <input type="text" class="form-control form-control-sm me-2" placeholder="Cari sparepart..." style="width: 200px;">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>2025-08-28</td>
                            <td>
                                <button class="btn btn-primary btn-action" data-bs-toggle="tooltip" title="Edit"><i class="bi bi-pencil"></i></button>
                                <button class="btn btn-danger btn-action" data-bs-toggle="tooltip" title="Hapus"><i class="bi bi-trash"></i></button>
                                <button class="btn btn-info btn-action" data-bs-toggle="tooltip" title="Detail"><i class="bi bi-eye"></i></button>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahSparepartModalLabel"><i class="bi bi-plus-circle me-2"></i>Tambah Sparepart Baru</h5>
                    ...
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="idSparepart" value="SP005" readonly>
                            </div>
                            <div class="col-md-6">
